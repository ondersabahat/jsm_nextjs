...
const Stats = ({ totalQuestions, totalAnswers, badges }: Props) => {
  return (
    <div className="mt-3">
      ...
      <div className="xs:grid-cols-2 mt-5 grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <StatsCard imgUrl="/icons/gold-medal.svg" value={badges.GOLD} title="Gold Medals" />
        <StatsCard imgUrl="/icons/silver-medal.svg" value={badges.SILVER} title="Silver Medals" />
        <StatsCard imgUrl="/icons/bronze-medal.svg" value={badges.BRONZE} title="Bronze Medals" />
      </div>
    </div>
  );
};
