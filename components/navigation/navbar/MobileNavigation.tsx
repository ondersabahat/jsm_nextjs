...
const MobileNavigation = async () => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="background-light900_dark200 border-none px-4 py-6">
          ...
          <div className="flex flex-col gap-3">
            {userId ? (
              <SheetClose asChild>
                ...
                >
                  <Button variant="ghost" type="submit" className="base-medium w-fit bg-transparent! px-4 py-3">
